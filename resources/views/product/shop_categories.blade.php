                                                ...
                                                <div class="single-product">
                                                    <div class="product-img">
                                                        <div class="single-prodcut-img  product-overlay pos-rltv">
                                                            <a href="{{route('shop.show',['id' => $product->id , 'slug' => $product->name])}}"> 
                                                                <img alt="" src="{{ Voyager::image( json_decode($product->image)[0] ) }}" class="primary-image"> 
                                                                <img alt="" src="{{ Voyager::image( json_decode($product->image)[1] ) }}" class="secondary-image">                                                            
                                                            </a>
                                                        </div>
                                                    </div>
