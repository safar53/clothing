                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-9 col-md-9">
                                        <div class="sort product-type">
                                            <span>Sort By :</span>
                                            <div class="sorting">
                                            <a href="{{ route('shop.brand',['sort' => 'low_high']) }}">Low to High</a>
                                            <a href="{{ route('shop.brand',['sort' => 'high_low']) }}">High to Low</a>
                                            </div>
                                                ...
                                                <div class="single-product">
                                                    <div class="product-img">
                                                        <div class="single-prodcut-img  product-overlay pos-rltv">
                                                            <a href="{{ route('shop.show',[$product->id , 'slug' => $product->name]) }}"> <img alt=""
                                                    ...
                                                    <div class="product-text">
                                                        <div class="prodcut-name"> <a href="{{ route('shop.show',[$product->id , 'slug' => $product->name]) }}">{{ $product->name }}</a> </div>
                                                ...
                                                <div class="single-product single-product-list">
                                                    ...
                                                    <div class="product-text prodcut-text-list fix">
                                                        <div class="prodcut-name list-name montserrat"> <a
                                                                href="{{ route('shop.show',[$product->id , 'slug' => $product->name]) }}">{{$product->name}}</a>
                                                        </div>
                                                        <div class="prodcut-ratting-price">
                    ...
                    <div class="shop-sidebar">
                        ...
                        <aside class="single-aside catagories-aside">
                            ...
                            <div id="cat-treeview" class="product-cat">
                                <ul>
                                    ...
                                    <li class="closed">
                                        <a href="{{route('shop.brand',['brand' => $brand->id])}}">{{$brand->name}}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        <aside class="single-aside color-aside">
                            ...
                            <ul class="color-filter mt-30">
                                @foreach ($colors as $color)
                                    <li><a href="{{ route('shop.brand',['brand' => request('brand') , 'size' => request('size') , 'price' => request('price') , 'color' => $color->id ]) }}" style="background-color:{{ $color->name }}" class="color-1"></a></li>
                                @endforeach                                
                            </ul>
                        </aside>
                        <!--single aside end-->
                        ...
                        <aside class="single-aside size-aside">
                            ...
                            <ul class="size-filter mt-30">
                                @foreach ($sizes as $size)
                                    <li><a href="{{ route('shop.brand',['brand' => request('brand') , 'color' => request('color') , 'price' => request('price') , 'size' => $size->id]) }}" class="size-s">{{$size->name}}</a></li>                                    
                                @endforeach
                            </ul>
                        </aside>
                        ...
                        <aside class="single-aside tag-aside">
                            ...
                            <ul class="tag-filter mt-30">
                                @foreach ($tags as $tag)
                                    <li><a href="{{ route('shop.brand',['brand' => request('brand') , 'color' => request('color') , 'price' => request('price') , 'size' => request('size') , 'tag' => $tag->id]) }}">{{ $tag->name }}</a></li>
                                @endforeach
                            </ul>
                        </aside>
                        <!--single aside end-->
